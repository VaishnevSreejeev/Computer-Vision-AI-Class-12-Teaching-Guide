...
# We will use a more robust template with newer versions and dev builds for better errors
...
<body class='bg-gray-50'>
    ...
    <script type='text/babel' data-type='module'>
        ...
        // Split imports to avoid 'as' keyword syntax error in Babel standalone
        import { 
...
# Filter out imports from App.js
...
# Reconstruct
final_html = html_template.replace('%APP_CODE%', final_app_code)
