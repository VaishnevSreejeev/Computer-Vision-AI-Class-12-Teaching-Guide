            ...
            <div className={`transition-opacity duration-1000 ${showLanding ? 'opacity-0 h-0 overflow-hidden' : 'opacity-100'}`}>
                ...
                <main className="max-w-6xl mx-auto px-4 py-8 grid md:grid-cols-12 gap-8">
                    ...
                    <div className="md:col-span-9 lg:col-span-9 pb-20">
                        <div className={activeSection === 'intro' ? 'block' : 'hidden'}><IntroSection /></div>
                        <div className={activeSection === 'pixels' ? 'block' : 'hidden'}><PixelLab /></div>
                        <div className={activeSection === 'pipeline' ? 'block' : 'hidden'}><PipelineDeepDive /></div>
                        <div className={activeSection === 'ml' ? 'block' : 'hidden'}><MLVisualizer /></div>
                        <div className={activeSection === 'apps' ? 'block' : 'hidden'}><ApplicationsSection /></div>
                        <div className={activeSection === 'quiz' ? 'block' : 'hidden'}><Quiz /></div>
